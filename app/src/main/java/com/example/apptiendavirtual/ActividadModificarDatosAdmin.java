...
public class ActividadModificarDatosAdmin extends AppCompatActivity {
        ...
        if (resultCode == RESULT_OK) {
            ...
            switch(requestCode) {
                case REQUEST_CODE_GRAVACION_IMAXE:
                    ...
                    ImageView imgview = (ImageView) findViewById(R.id.imageView20);
                ...
                case SELECT_FILE:
                    ...
                    if (selectedPath != null) {
                        ...
                        ImageView mImg = (ImageView) findViewById(R.id.imageView20);
...
// SDK < API11
    ...
    public void pedirPermiso(){
        if (Build.VERSION.SDK_INT>=23){
            ...
            if (permiso == PackageManager.PERMISSION_GRANTED
                ...
                ActivityCompat.requestPermissions(ActividadModificarDatosAdmin.this, new String[]{Manifest.permission.CAMERA,
    ...
    public void onRequestPermissionsResult(int requestCode, String permissions[], int[] grantResults) {
        ...
        switch (requestCode) {
            case CODIGO_IDENTIFICADOR: {
                Button btn = findViewById(R.id.button41);
                Button btn2 = findViewById(R.id.button42);
                // Permisos concedidos
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.actividad_modificar_datos_admin);
        if (baseDatos==null){
    ...
    public void actualizarDatosAdministrador (View v) {
        EditText editNom = findViewById(R.id.editText41);
        String nombreUs = editNom.getText().toString();
        EditText editApe = findViewById(R.id.editText42);
        String apellUs = editApe.getText().toString();
        EditText editEmail = findViewById(R.id.editText40);
        String emailUs = editEmail.getText().toString();
        EditText editPws3 = findViewById(R.id.editContra5);
        String nuevaContra = editPws3.getText().toString();
        EditText editPws2 = findViewById(R.id.editContra4);
        String repetirContra = editPws2.getText().toString();
        RadioButton radioCliente = findViewById(R.id.radioButton5);
        RadioButton radioAdministrador = findViewById(R.id.radioButton6);
        String nombre = null, apellidos = null, contraBd = null, email = null, tipoUsuario = "Cliente";
        int indice = 0;
        boolean controlCambios2 = false, controlCambios3 = false;
        Cursor cursor = operacionesBD.rawQuery("select us.nombre, us.apellidos, us.contra, us.email, us._id from Usuarios us join NombreLogin nlog on nlog.indice=us._id;", null);
        if (cursor.moveToFirst()) {
        ...
        if(radioCliente.isChecked() || radioAdministrador.isChecked() || nuevaContra.length()!=0 ||
            ...
            if(radioAdministrador.isChecked()){
                Toast.makeText(this, "Cambio de tipo usuario no guardado. Ya es un -Administrador-.",Toast.LENGTH_LONG).show();
            }
            else if(radioCliente.isChecked()){
                Toast.makeText(this, "El usuario ahora es  -Cliente-.",Toast.LENGTH_SHORT).show();
            ...
            //Si no se cambio el tipo de usuario, se vuelve a la ActividadAdministrador
